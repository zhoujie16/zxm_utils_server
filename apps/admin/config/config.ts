...
export default defineConfig({
   ...
   */
  proxy: proxy['dev' as keyof typeof proxy],
  /**
   * @name 快速热更新配置
  ...
  /**
   * @name 布局插件（ProLayout）
   * @description 启用后可在 src/app.tsx 使用 runtime layout 配置
   * @doc https://umijs.org/docs/max/layout-menu#layout
   */
  layout: {},
  /**
  ...
  /**
   * @name 禁用 source map
   * @description 构建时不生成 source map 文件
